 ...
 * An java.basic.NGram is a string of words of n length with a frequency f
 *  representing the proportion of times that the last word occurs after
 *  the words preceding it in the data set
 */
public class NGram {
    /**
     * Words stored in this java.basic.NGram.
     */
    private String[] words;

    /**
     * The final word of the java.basic.NGram, which is the prediction.
     */
    ...
    /**
     * @return the words in this java.basic.NGram
     */
